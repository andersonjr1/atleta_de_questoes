//Renders a dynamic leaderboard table showing user rankings
export function renderLeaderboard() {
  ...
  //Fetches leaderboard data from API and renders the table
    ...
    try {
      ...
      if (allUsers.length === 0) {
        ...
        top10Users.forEach((user, index) => {
          ...
          //Add cells for position, name and points
