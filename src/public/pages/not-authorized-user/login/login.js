...
function LoginPage() {
  ...
  <main id="mainLogin" class="auth-main">
      <div id="loginImage">
      ...
      <div id="loginInputs">
          ...
          <div id="formLogin" class="auth-form">
              ...
              <div class="input-auth-container">
                  ...
                  <input id="loginPasswordInput" type="password" class="input-auth" placeholder="Senha" name="password">
              </div>
              <div id="loginButtons" class="auth-buttons">
  ...
  <footer id="footerLogin" class="auth-footer">
