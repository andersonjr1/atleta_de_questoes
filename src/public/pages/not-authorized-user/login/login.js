    ...
    <div id="loginInputs">
        ...
        <form id="formLogin">
            <div class="inputLoginContainer">
                ...
                <input id="loginEmailInput" type="email" class="inputLogin" placeholder="Email" name="email">
            </div>
            <div class="inputLoginContainer">
                ...
                <input id="loginPasswordInput" type="password" class="inputLogin" placeholder="Senha" name="password">
            </div>
            <div id="loginButtons">
                <span id="spanRegistero">Registro</span>
