    ...
    profileContainer.innerHTML = `
        <div class="profile-header">
            <div class="profile-image-container">
                <img id="profileImage" src="${user.photo || '/default-profile.png'}" alt="Avatar">
            ...
            <div class="profile-info">
                ...
                ${user.level ? `<p class="user-level">Nível: ${user.level}</p>` : ''}
            </div>
        </div>
        <div class="profile-details">
            ...
            ${createProfileField('Criação da Conta', 'accountCreated', 'XX/XX/XXXX', false)}
        </div>
    `;
...
function setupProfileEvents(container) {
    ...
    container.querySelector(".profile-image-container")?.addEventListener("click", () => {
